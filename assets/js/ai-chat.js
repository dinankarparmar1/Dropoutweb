...
(function () {
  ...
  const STYLE = `
  .ai-fab{position:fixed;left:26px;bottom:26px;z-index:400;width:56px;height:56px;border-radius:50%;
  ...
  .ai-panel{position:fixed;left:26px;bottom:96px;z-index:401;width:360px;max-width:calc(100vw - 40px);
    height:520px;max-height:calc(100vh - 140px);background:var(--bg-raise,#111116);
    border:1px solid var(--panel-border-strong,rgba(212,175,55,.45));border-radius:18px;
